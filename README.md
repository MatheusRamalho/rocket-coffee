...
O projeto é uma landing page para uma empresa do ramo de café. Projeto desenvolvido durante aulas da Rocketseat
...
```bash
git clone https://github.com/MatheusRamalho/rocket-coffee
```
