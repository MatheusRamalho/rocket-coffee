...
export const handleResponsive = ({ device }: responsiveProps) => css`
    ${device === 'xl'
        ...
        ? css`
              ...
              @media screen and (max-width: ${(props) => props.theme.containers.extraLarge}) and (min-width: ${(props) =>
                      props.theme.containers.large}) {
                  @content;
                  background: yellow;
              }
          `
        ...
        ? css`
              ...
              @media screen and (max-width: ${(props) => props.theme.containers.large}) and (min-width: ${(props) =>
                      props.theme.containers.small}) {
                  @content;
                  background: blue;
              }
          `
